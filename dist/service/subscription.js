...
class SubscriptionService {
    ...
    static loadSubscribers() {
        const [subscriptionService, pubsubSubscriptionsDir,] = resourceResolver_1.ResourceResolver.getFiles();
        const subscriptionServiceClass = SubscriptionService.loadSubscriptionService();
        const loader = new subscriberLoader_1.default();
        SubscriptionService._subscribers = this.mergeSubscribers(loader.loadSubscribersFromService(subscriptionService, subscriptionServiceClass.defaultSubscriberOptions), loader.loadSubscribersFromDirectory(pubsubSubscriptionsDir, subscriptionServiceClass.defaultSubscriberOptions));
        return SubscriptionService._subscribers;
    }
