...
// highlight-next-line
export default class NewBuildSubscription extends Subscriber {
  public static topicName = 'cloud-builds';
  public static subscriptionName =
    'cloud-buids.gfs-kitchen-screens.update-build';
  public static description = 'Subscribes to cloud builds';
